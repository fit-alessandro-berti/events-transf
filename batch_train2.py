...
# Base config (defaults from config.py)
BASE_CONFIG = {
    "num_experts": 4,           # ← CHANGED: now 8 experts is the new "default"
...
# --- All jobs (only MoE jobs changed, everything else untouched) ---
TRAINING_JOBS = []
...
# num_experts already 8 → nothing to change
TRAINING_JOBS.append(job_moe_8)

# --- All the original non-MoE ablations (unchanged) ---
